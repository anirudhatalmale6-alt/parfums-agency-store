...
app.use((req, res, next) => {
  ...
  try {
    ...
    res.locals.textColor = allSettings.text_color || '#000000';
    ...
    res.locals.borderColor = allSettings.border_color || '#000000';
